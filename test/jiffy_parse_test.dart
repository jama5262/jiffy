...
void main() {
  group('Test Jiffy cloning', () {
    ...
    test('Test with clone() function manipulation by adding 10 years should not be equal',  () {
      var jiffy1 = Jiffy([2021]);
      var jiffy2 = jiffy1.clone();
      jiffy1..add(years: 10);
    ...
    test('Test clone from instance manipulation by adding 10 years should not be equal',  () {
      var jiffy1 = Jiffy([2021]);
      var jiffy2 = Jiffy(jiffy1);
      jiffy1..add(years: 10);
      expect(jiffy1.year, isNot(jiffy2.year));
