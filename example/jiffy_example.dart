...
//   Jiffy('2030-12-31').fromNow(maxRelativeTimeUnit: Unit.MONTH); // 108 months
//   Jiffy('2021-12-31').fromNow(maxRelativeTimeUnit: Unit.MINUTE); // 59794 minutes ago
//   Jiffy('2021-12-31').fromNow(maxRelativeTimeUnit: Unit.HOUR); // 997 hours ago
//   Jiffy('2021-12-31').fromNow(maxRelativeTimeUnit: Unit.DAY); // 42 days ago
//   Jiffy('2020-12-31').fromNow(maxRelativeTimeUnit: Unit.MONTH); // 14 months ago
//   Jiffy('2000-12-31').fromNow(maxRelativeTimeUnit: Unit.MONTH); // 257 months ago
//   Jiffy('2000-12-31').fromNow(maxRelativeTimeUnit: Unit.YEAR); // 21 years ago
//
//   Jiffy().startOf(Unit.HOUR).fromNow(); // 9 minutes ago
//
...
//   jiffy2.from([2017, 1, 30], maxRelativeTimeUnit: Unit.MONTH); // 122 months ago
//
...
//   Jiffy([2007, 1, 28]).diff([2017, 1, 29], Unit.DAY); // -3654
//
// //  RELATIVE TIME
//   Jiffy('2011-10-31').fromNow(); // 8 years ago
//   Jiffy(DateTime(2012, 6, 20)).fromNow(); // 7 years ago
//
//   Jiffy().startOf(Unit.DAY).fromNow(); // 19 hours ago
//
//   Jiffy().endOf(Unit.DAY).fromNow(); // in 5 hours
//
//   Jiffy().startOf(Unit.HOUR).fromNow(); // 9 minutes ago
//
// //  MANIPULATING DATES
